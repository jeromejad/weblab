...
<input type="text" class="input-group-sm" placeholder="enter new item" ng-model="item">
<input type="button" class="btn btn-outline-dark p-2 m-2" value="add" ng-click="addItem()">
<ul>
<li class="d-flex justify-content-between" ng-repeat="x in items"> {{x}}  <span class="btn btn-outline-danger btn-sm " ng-click="delItem($index)"> delete </span></li>
</ul>
</div>
<script>
            var app = angular.module("myapp", []);
           app.controller("myctrl", function($scope) {
            $scope.items = ["Pray well","Call mom","Do assignment"];
